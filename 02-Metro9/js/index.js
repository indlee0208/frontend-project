$(function () {
    ...
    $(".contents > .customerWrapBS > .customer > ul > li").hover(function () {
        var i = $(this).index();
        $(".contents > .customerWrapBS > .customer > ul > li").eq(i).find(".customerTop").stop().animate({
            width: "100%"
        }, 300);

        $(".contents > .customerWrapBS > .customer > ul > li").eq(i).find(".customerRight").stop().delay(300).animate({
            height: "100%"
        }, 300);

        $(".contents > .customerWrapBS > .customer > ul > li").eq(i).find(".customerBottom").stop().animate({
            width: "100%"
        }, 300);

        $(".contents > .customerWrapBS > .customer > ul > li").eq(i).find(".customerLeft").stop().delay(300).animate({
            height: "100%"
        }, 300);
        ...
        var i = $(this).index();
        $(".contents > .customerWrapBS > .customer > ul > li").eq(i).find(".customerTop").stop().delay(300).animate({
            width: "0px"
        }, 300);

        $(".contents > .customerWrapBS > .customer > ul > li").eq(i).find(".customerRight").stop().animate({
            height: "0px"
        }, 300);

        $(".contents > .customerWrapBS > .customer > ul > li").eq(i).find(".customerBottom").stop().delay(300).animate({
            width: "0px"
        }, 300);

        $(".contents > .customerWrapBS > .customer > ul > li").eq(i).find(".customerLeft").stop().animate({
            height: "0px"
        }, 300);
    });
